define(function (require) {
    ...
    var BaseAmountPromotionSelectView = require('app/promotion/BaseAmountSelectView');
    var BaseSalesorderPromotionSelectView = require('app/promotion/BaseSalesorderSelectView');
    ...
    var conponType = [
        ...
        { text: "Voucher tiền mặt", value: 'value' }
    ];
        ...
        render: function () {
            ...
            self.model.on("change:contact_phone", function ($event) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // setTimeout(() => {
                        //     self.$el.find("button[btn-name=save]").remove();
                        //     self.$el.find("button[btn-name=delete]").remove();
                        // }, 200);
                    },
            ...
            self.model.on("change:coupon_type", function (event) {
                if (self.model.get("coupon_type") == "value") {
                    ...
                    //     //valueField: "id",
                    //     selectionMode: "single",
                    //     dataSource: BaseAmountPromotionSelectView
                    // });
                    ...
                    //     //valueField: "id",
                    //     selectionMode: "single",
                    //     dataSource: BaseSalesorderPromotionSelectView
                    // });
